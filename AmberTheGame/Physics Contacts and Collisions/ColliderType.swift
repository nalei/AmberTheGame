...
//  static var ENEMY:  ColliderType { return self.init(rawValue: 1 << 2) } // bitmask is ...00000100
    ...
    static let PLAYER  = ColliderType(rawValue: 1 << 0).rawValue // bitmask is ...00000001
    static let GROUND  = ColliderType(rawValue: 1 << 1).rawValue // bitmask is ...00000010
    static let ENEMY   = ColliderType(rawValue: 1 << 2).rawValue // bitmask is ...00000100
  
  
  // MARK: - SpriteKit Physics Convenience
  /// Значение, которое  будет  присвоено свойству `categoryMask` физического тела объекта.
//  var categoryMask: UInt32 {
//    return rawValue
//  }
  
  /// Значение, которое  будет  присвоено свойству `collisionMask` физического тела объекта.
...
//  }
  ...
  /// Значение, которое  будет  присвоено свойству `contactMask` физического тела объекта.
